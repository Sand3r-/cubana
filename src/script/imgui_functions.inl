...
LABEL_ARG(text)
DEFAULT_ARG(const char*, text_end, NULL)
...
LABEL_ARG(str_id)
IM_VEC_2_ARG(size)
DEFAULT_ARG(ImGuiButtonFlags, flags, 0)
...
DEFAULT_ARG(const char*, overlay, NULL)
...
DEFAULT_ARG(const char*, format, "%.3f")
DEFAULT_ARG(ImGuiSliderFlags, flags, 0)
...
OPTIONAL_NUMBER_ARG(v_max, 0.0f)
DEFAULT_ARG(const char*, format, "%.3f")
DEFAULT_ARG(const char*, format_max, NULL)
DEFAULT_ARG(ImGuiSliderFlags, flags, 0)
...
DEFAULT_ARG(const char*, format, "%d")
DEFAULT_ARG(ImGuiSliderFlags, flags, 0)
...
DEFAULT_ARG(const char*, format, "%.0f deg")
DEFAULT_ARG(ImGuiSliderFlags, flags, 0)
...
LABEL_ARG(prefix)
NUMBER_ARG(v)
DEFAULT_ARG(const char*, float_format, NULL)
...
LABEL_ARG(label)
DEFAULT_ARG(const char*, shortcut, NULL)
OPTIONAL_BOOL_ARG(selected, false)
OPTIONAL_BOOL_ARG(enabled, true)
...
LABEL_ARG(str_id)
DEFAULT_ARG(ImGuiPopupFlags, popup_flags, 0)
...
DEFAULT_ARG(const char*, str_id, NULL)
DEFAULT_ARG(ImGuiPopupFlags, popup_flags, 1)
...
LABEL_ARG(str_id)
DEFAULT_ARG(ImGuiPopupFlags, flags, 0)
...
LABEL_ARG(str_id)
INT_ARG(column)
DEFAULT_ARG(ImGuiTableFlags, flags, 0)
...
DEFAULT_ARG(ImGuiTableRowFlags, row_flags, 0)
...
LABEL_ARG(label)
DEFAULT_ARG(ImGuiTableColumnFlags, flags, 0)
...
OPTIONAL_INT_ARG(count, 1)
DEFAULT_ARG(const char*, id, NULL)
...
UINT_ARG(id)
OPTIONAL_IM_VEC_2_ARG(size, 0, 0)
DEFAULT_ARG(ImGuiDockNodeFlags, flags, 0)
DEFAULT_ARG(const ImGuiWindowClass*, window_class, NULL)
CALL_FUNCTION(DockSpace, unsigned int, id, size, flags, window_class)
PUSH_NUMBER(ret)
END_IMGUI_FUNC
...
IMGUI_FUNCTION(DockSpaceOverViewport)
DEFAULT_ARG(const ImGuiViewport*, viewport, NULL)
DEFAULT_ARG(ImGuiDockNodeFlags, flags, 0)
DEFAULT_ARG(const ImGuiWindowClass*, window_class, NULL)
CALL_FUNCTION(DockSpaceOverViewport, unsigned int, viewport, flags, window_class)
PUSH_NUMBER(ret)
END_IMGUI_FUNC
...
OPTIONAL_INT_ARG(auto_open_depth, -1)
DEFAULT_ARG(const char*, filename, NULL)
...
// Unsupported arg type ImGuiMouseCursor cursor_type
